...
CREATE INDEX idx_kc_source_ref ON t_knowledge_chunk (source_ref);
CREATE INDEX idx_kc_conflict_pair ON t_knowledge_chunk (conflict_pair_id);
CREATE INDEX idx_kc_confidence ON t_knowledge_chunk (confidence);
...
COMMENT ON COLUMN t_knowledge_chunk.confidence IS '置信度分数（相似向量提交次数）';
...
-- ============================================
-- Module & Feature Metadata Tables
-- ============================================
...
CREATE INDEX idx_module_deleted ON t_module (deleted);
...
CREATE INDEX idx_fm_deleted ON t_feature_metadata (deleted);
